...
import { ExamplePieChart } from '@/components/landing-page/example-pie-chart';
...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <footer className="w-full py-8 bg-pink-600 border-t">
          <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center text-sm text-white">
