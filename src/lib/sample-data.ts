...
/**
 * Contém a lista de transações de exemplo para popular a conta de um novo usuário.
 * Estes dados foram extraídos do script 'simulateBankTransactions.js'.
 * A estrutura corresponde exatamente ao modelo de dados no Firestore.
 */
