...
"[project]/node_modules/jsonata/jsonata.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
 ...
 */ const dateTime = function() {
     ...
     */ function analyseIntegerPicture(picture) {
                        ...
                        /* eslnt-disable-next no-fallthrough */ switch(primaryFormat){
                            case 'A':
                                format.case = tcase.UPPER;
                            /* eslnt-disable-next-line no-fallthrough */ case 'a':
                                format.primary = formats.LETTERS;
                                break;
                            case 'I':
                                format.case = tcase.UPPER;
                            /* eslnt-disable-next-line no-fallthrough */ case 'i':
 ...
 */ var utils = require('./utils');
                                    ...
                                    if (typeof pattern === 'string') {
                                        ...
                                        if (typeof matches !== 'undefined') {
                                            while(typeof matches !== 'undefined' && (typeof limit === 'undefined' || count < limit)){
                                                ...
                                                var replacedWith = replacer.apply(self1, [
                                                    matches
                                                ]);
     ...
     */ function base64encode(str) {
                                ...
                                var btoa = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : function(str) {
                                    // Simply doing `new Buffer` at this point causes Browserify to pull
                                    // in the entire Buffer browser library, which is large and unnecessary.
                                    // Using `global.Buffer` defeats this.
                                    return new global1.Buffer.from(str, 'binary').toString('base64'); // eslint-disable-line new-cap
                                };
                                return btoa(str);
                            }
                            /**
     ...
     */ function base64decode(str) {
                                ...
                                // Use btoa in a browser, or Buffer in Node.js
                                var atob = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : function(str) {
                                    // Simply doing `new Buffer` at this point causes Browserify to pull
                                    // in the entire Buffer browser library, which is large and unnecessary.
                                    // Using `global.Buffer` defeats this.
                                    return new global1.Buffer.from(str, 'base64').toString('binary'); // eslint-disable-line new-cap
                                };
                                return atob(str);
                            }
                            /**
     ...
     */ function round(arg, precision) {
                                ...
                                if (precision) {
                                    ...
                                    /* istanbul ignore next */ result = +(value[0] + 'e' + (value[1] ? +value[1] - precision : -precision));
                                }
     ...
     */ function hofFuncArgs(func, arg1, arg2, arg3) {
                                var func_args = [
                                    arg1
                                ]; // the first arg (the value) is required
     ...
     */ async function sift(arg, func) {
                        ...
                        module1.exports = functions;
                    }).call(this);
                }).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : {});
            },
            {
                "./utils": 6
            }
 ...
 */ var jsonata = function() {
     ...
     */ async function evaluateUnary(expr, input, environment) {
                        ...
                        switch(expr.value){
                            ...
                            case '[':
                                ...
                                result = [];
                                let generators = await Promise.all(expr.expressions.map(async (item, idx)=>{
                                    environment.isParallelCall = idx > 0;
                                    return [
                                        item,
                                        await evaluate(item, input, environment)
                                    ];
                                }));
     ...
     */ async function evaluateGroupExpression(expr, input, environment) {
                        ...
                        let generators = await Promise.all(Object.keys(groups).map(async (key, idx)=>{
                            ...
                            return [
                                key,
                                await evaluate(expr.lhs[entry.exprIndex][1], context, env)
                            ];
                        }));
                        for (let generator of generators){
     ...
     */ async function evaluateSortExpression(expr, input, environment) {
                        ...
                        result = await fn.sort.apply(focus, [
                            lhs,
                            comparator
                        ]);
                        return result;
     ...
     */ function evaluateTransformExpression(expr, input, environment) {
                        ...
                        var transformer = async function(obj) {
                            ...
                            var result = await apply(cloneFunction, [
                                obj
                            ], null, environment);
     ...
     */ async function evaluateApplyExpression(expr, input, environment) {
                        ...
                        if (expr.rhs.type === 'function') {
                            ...
                            result = await evaluateFunction(expr.rhs, input, environment, {
                                context: lhs
                            });
                        } else {
                            ...
                            if (isFunction(lhs)) {
                                ...
                                result = await apply(chain, [
                                    lhs,
                                    func
                                ], null, environment);
                            } else {
                                result = await apply(func, [
                                    lhs
                                ], null, environment);
                            }
                        }
     ...
     */ function evaluateLambda(expr, input, environment) {
                        ...
                        procedure.apply = async function(self1, args) {
                            return await apply(procedure, args, input, !!self1 ? self1.environment : environment);
                        };
                        return procedure;
                    }
                    /**
                    ...
                    var parser = function(source, recover) {
                            ...
                            if (node.id !== "}") {
                                for(;;){
                                    ...
                                    a.push([
                                        n,
                                        v
                                    ]); // holds an array of name/value expression pairs
                                    if (node.id !== ",") {
                                        break;
                                    }
                                    advance(",");
                        ...
                        var processAST = function(expr) {
                            ...
                            switch(expr.type){
                                ...
                                default:
                                    var code = "S0206";
                                    /* istanbul ignore else */ if (expr.id === '(end)') {
                                        code = "S0207";
                                    }
                                    var err = {
                                        code: code,
 ...
 */ const utils = (()=>{
     ...
     */ function isArrayOfStrings(arg) {
                        var result = false;
                        /* istanbul ignore else */ if (Array.isArray(arg)) {
...
//# sourceMappingURL=node_modules_jsonata_jsonata_26ff8a0d.js.map